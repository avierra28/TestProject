...
<!--                   First Row       						 -->
                  <div class="row">
                    ...
                    <div class="col-sm-9 text-secondary">
                      <p>${staff.getFirstName()} ${staff.getLastName()}</p>
                    </div>
                  </div>
                  <hr>
<!--                   Second Row       						 -->
